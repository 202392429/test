...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bttnadd = (Button) findViewById(R.id.add);
        bttnshow1 = (Button) findViewById(R.id.show);
        bttnshowall = (Button) findViewById(R.id.showall);
        ...
        bttnadd.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                String getage =editage.getText().toString();
        ...
        bttnshowall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent c = new Intent
                        (getApplicationContext(),res.class);
                startActivity(c);
