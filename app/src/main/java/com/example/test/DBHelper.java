...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public boolean insertContact  (String name, String phone, String email , String age){
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public boolean updateContact (Integer id, String name, String phone, String email, String age)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("name", name);
    ...
    public ArrayList<String> getAllContacts() {
        ...
        while(res.isAfterLast() == false){
            ...
            array_list.add(res.getString(res.getColumnIndex(CONTACTS_COLUMN_age)));
